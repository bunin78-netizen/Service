...
rem === Step 4: Clean dist ===
echo  [3/5] Removing old build...
if exist "dist\" (
    rmdir /s /q "dist"
...
rem === Step 6: Build ===
echo  [5/5] Building SmartKharkov...
...
echo.
echo  =====================================================
echo   [SUCCESS] SmartKharkov rebuilt successfully!
echo  =====================================================
echo.
